                    ...
                    <div className='p-6 grid place-items-center'>
                        ...
                        <div className='my-10 w-[100%] grid place-items-center'>
                            <button
                                type='submit'
                                disabled={loading}
                                className=' grid place-items-center bg-backPrimary_color w-36 text-text_color1 text-xl font-bold px-4 py-1 rounded-lg hover:bg-transparent border-2 border-backPrimary_color hover:text-text_color3 transition-all duration-300'
                            >
                                {
                                    loading == false
